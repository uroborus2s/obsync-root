...
[Home](./index.md) &gt; [@stratix/utils](./utils.md) &gt; [common](./utils.common.md) &gt; [pipeAsync](./utils.common.pipeasync.md)

## common.pipeAsync() function
...
```typescript
export declare function pipeAsync<T = any, R = any>(...fns: Array<(arg: any) => any | Promise<any>>): (arg: T) => Promise<R>;
```
