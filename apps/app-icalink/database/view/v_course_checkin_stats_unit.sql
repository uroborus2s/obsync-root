--
-- View `v_course_checkin_stats_by_unit`
--
-- This view provides a summary of check-in statistics grouped by course unit,
-- calculating absence and truancy rates.
--
CREATE OR REPLACE VIEW `v_course_checkin_stats_unit` AS
SELECT
    `course_unit_id`,
