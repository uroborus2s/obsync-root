...
CREATE TABLE icasync.icalink_teaching_class (
  ...
  school_id VARCHAR(30) COMMENT '学院代码（可空，继承视图）',
  major_id VARCHAR(30) COMMENT '专业代码（可空，继承视图）',
  major_name VARCHAR(90) COMMENT '专业名称（可空，继承视图）',
  class_id VARCHAR(30) COMMENT '班级代码（可空，继承视图）',
  class_name VARCHAR(90) COMMENT '班级名称（可空，继承视图）',
  grade VARCHAR(10) COMMENT '年级（可空，继承视图）',
  gender VARCHAR(10) COMMENT '性别（可空，继承视图）',
  people VARCHAR(10) COMMENT '民族（可空，继承视图）',
  ...
  course_unit_id VARCHAR(20) COMMENT '开课单位代码（可空，继承视图）',
