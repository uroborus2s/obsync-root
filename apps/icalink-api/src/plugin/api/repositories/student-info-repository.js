...
export class StudentInfoRepository extends BaseRepository {
     ...
     * 获取学院专业班级树形结构
     */
    async getCollegeMajorClassTree() {
        try {
            const results = await this.db
                .selectFrom('out_xsxx')
                .select([
...
//# sourceMappingURL=student-info-repository.js.map