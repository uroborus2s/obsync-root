...
export class StudentCourseRepository extends BaseRepository {
     ...
     * 根据开课号和学年学期查询学生列表
     */
    async findStudentsByKkhAndXnxq(kkh, xnxq) {
        try {
            const results = await this.db
                .selectFrom('out_jw_kcb_xs')
                .selectAll()
     ...
     */
    async findStudentsWithDetailsByCourse(kkh, xnxq) {
        try {
            const results = await this.db
                .selectFrom('out_jw_kcb_xs')
     ...
     * 获取学生课表统计信息
     */
    async getStudentCourseStats(xnxq) {
        try {
            const results = await this.db
                .selectFrom('out_jw_kcb_xs')
                .select([
     ...
     * 获取课程的学生数量
     */
    async getStudentCountByKkh(kkh) {
        try {
     ...
     * 获取学生的课程数量
     */
    async getCourseCountByXh(xh, xnxq) {
        try {
            let query = this.db
                .selectFrom('out_jw_kcb_xs')
     ...
     * 检查学生是否选修了指定课程
     */
    async hasStudentCourse(xh, kkh, xnxq) {
        try {
            let query = this.db
                .selectFrom('out_jw_kcb_xs')
                .select('xh')
...
//# sourceMappingURL=student-course-repository.js.map