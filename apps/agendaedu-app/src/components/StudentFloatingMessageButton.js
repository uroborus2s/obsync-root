...
export function StudentFloatingMessageButton({ className = '' }) {
    ...
    return (<div className={`fixed bottom-6 right-4 z-50 ${className}`}>
      <button onClick={handleClick} disabled={isLoading} className='relative flex h-14 w-14 items-center justify-center rounded-full bg-blue-500 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-blue-600 active:scale-95 disabled:opacity-50' aria-label={pendingCount > 0
...
//# sourceMappingURL=StudentFloatingMessageButton.js.map