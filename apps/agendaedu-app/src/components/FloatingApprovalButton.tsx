  ...
  return (
    <div className={`fixed z-50 ${className}`}>
      <div className='group relative'>
        ...
        <button
          onClick={handleClick}
          className='relative flex h-14 w-14 items-center justify-center rounded-full border border-purple-400/30 bg-gradient-to-br from-purple-500 via-purple-600 to-pink-600 text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:from-purple-600 hover:via-pink-600 hover:to-purple-700 hover:shadow-purple-500/50 active:scale-95'
          aria-label={`查看请假审批，有${pendingCount}个待处理`}
        >
          {/* 内部渐变光效 */}
          ...
          <div className='relative'>
            ...
            <div className='relative whitespace-nowrap rounded-xl border border-gray-700/50 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 py-3 text-sm text-white shadow-2xl'>
              ...
              <div className='relative z-10 flex items-center space-x-2'>
                ...
                {pendingCount > 0 && (
                  <span className='rounded-full bg-gradient-to-r from-red-500 to-orange-500 px-2 py-0.5 text-xs font-bold'>
                    {pendingCount}个待处理
                  </span>
                )}
              </div>
