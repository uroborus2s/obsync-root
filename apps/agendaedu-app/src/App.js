    ...
    return (<div className='bg-background min-h-screen'>
      <main>
        <Routes>
          ...
          {/* 404 路由 */}
          <Route path='*' element={<div className='flex min-h-screen items-center justify-center bg-yellow-50'>
                <div className='p-8 text-center'>
                  ...
                  <button onClick={() => (window.location.href = '/app/')} className='rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600'>
                    返回首页
                  </button>
                </div>
              </div>}/>
