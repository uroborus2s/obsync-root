...
import { Calendar, CheckCircle, ClipboardList, FileText, UserCheck, Users } from 'lucide-react';
      ...
      <div className='px-4 py-6'>
        ...
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            {quickActions.map((action) => (<button key={action.path} onClick={() => navigate(action.path)} className='rounded-lg bg-white p-4 shadow-sm transition-shadow hover:shadow-md'>
