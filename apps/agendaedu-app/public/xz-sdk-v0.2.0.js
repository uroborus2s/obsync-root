...
!(function (e, n) {
  ...
  'undefined' != typeof module
    ...
    ? define(n)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).ksoxz_sdk = n())
})(this, function () {
  'use strict'
  var e = (function () {
      function e() {
  ...
  function t(e, n) {
    ...
    if (null != e && 'function' == typeof Object.getOwnPropertySymbols) {
      ...
      for (o = Object.getOwnPropertySymbols(e); i < o.length; i++)
        n.indexOf(o[i]) < 0 && Object.prototype.propertyIsEnumerable.call(e, o[i]) && (t[o[i]] = e[o[i]])
    }
    return t
  }
  function o(e, n, t) {
  ...
  var i,
    r,
    a = { uploadFile: 'setUploadFileEvent', downloadFile: 'setDownloadFileEvent' },
    c = 'onProgressUpdate'
  !(function (e) {
      ...
      return (
        ...
        (t.prototype.getProgressInstance = function (e, n) {
          ...
          return {
            ...
            abort: function () {
              var t,
                o = { params: { taskId: n } }
              null === (t = window.ksoxz_sdk) || void 0 === t || t.core.invokeAbortApi(e, o, n)
            },
        ...
        (t.prototype.getInvokeProgressApiParams = function (e, t, o) {
          ...
          var i = o || ''.concat(e, '_').concat(this.eventListener.id),
            r = { methodName: e, callbackName: i, params: n(n({}, t.params), { taskId: i }) },
            a = this.getProgressInstance(e, i)
          return o || this.eventListener.addListener(i, t), { invokeParams: r, progressParams: a }
        }),
            ...
            ? a.event === r.CREATED
              ? ((c.eventList || []).forEach(function (e) {
                  var n,
                    t = e.eventName,
                    o = e.payload
                  null === (n = window.ksoxz_sdk) || void 0 === n || n.core.invokeApi(t, o)
                }),
                (c.eventList = []))
              : c[a.event] && c[a.event](a)
            : (c &&
                (o === i.SUCCESS ? c.onSuccess(a) : c.onError(a),
                null === (n = c.options) || void 0 === n ? void 0 : n.undeleteCallback)) ||
  ...
  var d = (function () {
        ...
        (e.prototype.initBridge = function () {
          window.addEventListener('message', function (e) {
            if (
              ...
              'xz_sdk_callback' === n.eventName && u.getInstance().handleCallbackEvent(n.payload)
            }
          }),
            window.WOA_electron &&
              window.WOA_electron.ipcRenderer.on('sdk_callback', function (e, n) {
        ...
        (e.prototype.sendApi = function (e) {
          window.woa
            ...
            : window.WOA_electron &&
              ...
              (e.payload = e.params),
              window.WOA_electron.ipcRenderer.sendToHost('sdk__postMessage', JSON.stringify(e)))
        }),
      ...
      return (
        ...
        (e.prototype.initBridge = function () {
          ...
          v
            ...
            : g &&
              ((this.version = (e = f.match(/ios-woa\/(\S*)/gm)) ? e[0].split('/')[1] : ''),
              (window.WOA_Sdk = {
                callback: function (e) {
    ...
    k = new ((function () {
      function n() {
        this.apiList = []
        var e = l ? d : h
        ;(this.bridge = e.getInstance()), b || console.warn('please use in kso xiezuo client environment')
      }
      return (
  ...
  var I = function (e, n, t) {
    return (
      ...
      function () {
        for (var o = arguments, i = -1, r = L(o.length - n, 0), a = Array(r); ++i < r; ) a[i] = o[n + i]
        i = -1
  ...
  var Q,
    ...
    q = (Q = /[^.]+$/.exec((H && H.keys && H.keys.IE_PROTO) || '')) ? 'Symbol(src)_1.' + Q : ''
  var K = function (e) {
      return !!q && q in e
    },
  ...
  var pe = function (e, n) {
    ...
    ve = le
      ? function (e, n) {
          return le(e, 'toString', { configurable: !0, enumerable: !1, value: fe(n), writable: !0 })
        }
      : C,
    ge = Date.now
  var be = function (e) {
      ...
      return {
        ...
        remove: function (n) {
          ...
          r.delete(n),
            a &&
              !r.size &&
              ((o = u.getInstance().getInvokeApiParams(t, { params: { callbackName: i } })),
    ...
    Ve = Object.freeze({
      ...
      shareMessage: function (e) {
        ...
        return k.bridge.invokeApi(
          'shareMessage',
          n(n({}, e), { params: n(n({}, a), { channelObject: r ? JSON.stringify(r) : void 0 }) })
        )
      },
      ...
      accelerometerWatchShake: function (e) {
        return (e.options = { undeleteCallback: !0 }), k.bridge.invokeApi('accelerometerWatchShake', e)
      },
      ...
      removeNetworkListener: function () {
        return (
          e.getInstance().removeListener('setNetworkListener'), k.bridge.invokeApi('removeNetworkListener')
        )
      },
      ...
      chooseImage: function (e) {
        ...
        return k.bridge.invokeApi(
          'chooseImage',
          n(n({}, e), { params: n(n({}, a), { watermarkConfig: r ? JSON.stringify(r) : void 0 }) })
        )
      },
      ...
      setNavigationButton: function (e) {
        return (e.options = { undeleteCallback: !0 }), k.bridge.invokeApi('setNavigationButton', e)
      },
      ...
      configureMenu: function (e) {
        return k.bridge.invokeApi('configureMenu', n(n({}, e), { options: { undeleteCallback: !0 } }))
      },
      ...
      removeAppInfoListener: function () {
        return (
          e.getInstance().removeListener('setAppInfoListener'), k.bridge.invokeApi('removeAppInfoListener')
        )
      },
      writeLog: function (e) {
  ...
  return b && ((window.ksoxz_sdk = Ve), console.log('ksoxz jssdk version:', A)), Ve
})
