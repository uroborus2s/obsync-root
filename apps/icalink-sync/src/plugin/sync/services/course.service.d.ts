...
export declare class CourseService {
    ...
    constructor(db: Kysely<ExtendedDatabase>, log: Logger, courseScheduleRepo: CourseScheduleRepository, attendanceRepo: AttendanceRepository, courseAggregateRepo: CourseAggregateRepository, teacherInfoRepo: TeacherInfoRepository);
    /**
     * 根据考勤记录ID获取课程的授课教师信息
     */
