...
import { SyncTaskService, aggregateExecutor, createCourseSyncExecutor, deleteCourseExecutor, getCoursesExecutor, scheduleCreationExecutor } from './services/index.js';
/**
 * AgendaEdu插件主函数
 */
async function icalinkSyncPlugin(fastify, options) {
    // 注册仓库
