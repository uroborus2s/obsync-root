...
export function TaskStatusFilter({ table, }) {
        ...
        <Command>
          ...
          <CommandList>
            ...
            return (<CommandItem key={option.value} onSelect={() => {
                    ...
                    <div className={cn('border-primary mr-2 flex h-4 w-4 items-center justify-center rounded-sm border', isSelected
...
//# sourceMappingURL=task-status-filter.js.map