...
import { BarChart3, Calendar, Clock, TrendingUp, UserCheck, Users, } from 'lucide-react';
...
export function AttendanceOverview() {
    ...
    if (loading) {
        ...
        {[...Array(4)].map((_, index) => (<Card key={index}>
...
//# sourceMappingURL=attendance-overview.js.map