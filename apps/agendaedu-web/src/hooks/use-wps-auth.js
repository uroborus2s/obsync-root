...
export function useWpsAuth() {
    ...
    const checkAuthStatus = useCallback(async () => {
        ...
        try {
            // 直接向服务器验证认证状态
            const response = await fetch('https://chat.whzhsc.cn/apiv2/tasks/tree/roots?page=1&page_size=1', {
                method: 'GET',
...
//# sourceMappingURL=use-wps-auth.js.map