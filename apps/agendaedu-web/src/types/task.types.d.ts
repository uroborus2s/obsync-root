 ...
 * 任务类型
 */
export type TaskType = 'sync' | 'attendance' | 'aggregate' | 'teacher-schedule' | 'student-schedule' | 'full-sync' | 'incremental-sync' | 'cleanup' | 'notification' | 'export' | 'import' | 'validation' | 'other';
/**
 * 分页响应接口
 */
