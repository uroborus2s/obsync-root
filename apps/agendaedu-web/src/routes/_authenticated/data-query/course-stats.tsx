...
export const Route = createFileRoute('/_authenticated/data-query/course-stats')(
  {
...
function CourseStatsPage() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: () => statsApiService.getCourseStats(filters),
  ...
  return (
    <div className='flex-1 space-y-6 p-4 pt-6 md:p-8'>
      <div className='flex items-center justify-between'>
        <div>
          <h2 className='text-3xl font-bold tracking-tight'>课程历史统计</h2>
          <p className='text-muted-foreground'>查询课程考勤统计数据</p>
        </div>
      </div>
        ...
        <CardContent className='space-y-4'>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            <div className='space-y-2'>
              ...
              <Input
                id='searchKeyword'
                placeholder='课程名称、课程代码、教师姓名、教师工号'
              ...
              <TableHeader>
                <TableRow>
                  <TableHead
                    ...
                    onClick={() => handleSort('stat_date')}
                  >
                    统计日期
                    {filters.sortField === 'stat_date' && (
                      <span className='ml-1'>
                  ...
                  <TableHead>应到人数</TableHead>
                  <TableHead>实到人数</TableHead>
                  <TableHead>缺勤人数</TableHead>
                  <TableHead>旷课人数</TableHead>
                  <TableHead>请假人数</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {isLoading ? (
                  ...
                  records.map((record: CourseCheckinStats) => (
                    <TableRow key={record.id}>
                      ...
                      <TableCell>{record.teacher_codes}</TableCell>
                      ...
                      <TableCell>{record.expected_count}</TableCell>
                      <TableCell>{record.actual_count}</TableCell>
                      <TableCell>
