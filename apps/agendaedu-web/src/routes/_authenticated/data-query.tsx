          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            ...
            <div className='space-y-2'>
              ...
              <Select
                ...
                value={filters.week ? String(filters.week) : 'all'}
              >
          ...
          <div className='space-y-2'>
            ...
            <div className='grid grid-cols-1 gap-4 sm:grid-cols-2'>
              <div className='flex items-center gap-2'>
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {filters.startTime ? (
                        format(filters.startTime, 'PPP', { locale: zhCN })
                      ) : (
                        <span>开始日期</span>
                      )}
                    </Button>
                ...
                <Select
                  value={
                    filters.startTime ? format(filters.startTime, 'HH:mm') : ''
                  }
                  onValueChange={(value) => {
                    if (!value) {
              ...
              <div className='flex items-center gap-2'>
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      <CalendarIcon className='mr-2 h-4 w-4' />
                      {filters.endTime ? (
                        format(filters.endTime, 'PPP', { locale: zhCN })
                      ) : (
                        <span>结束日期</span>
                      )}
                    </Button>
                ...
                <Select
                  value={
                    filters.endTime ? format(filters.endTime, 'HH:mm') : ''
                  }
                  onValueChange={(value) => {
                    if (!value) {
          ...
          <Table>
            ...
            <TableBody>
              {isLoading ? (
                ...
                results.map((record: DataQueryRecord) => (
