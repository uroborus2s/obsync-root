...
- 2026-07-24 `BUG-007` 发布候选已通过独立评审：`@stratix/database@1.1.1` tarball 的 Core peer 从精确版本修正为 `^1.1.0`；Database 49/49 tests、完整 `quality:release` 和 Aliyun publish dry-run 通过。当前唯一剩余动作是执行已授权 Aliyun 私库发布，并反查精确版本与 `latest`。
