...
CREATE TABLE `juhe_renwu` (
  ...
  `jc_s` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '节次合并',
  ...
  `sjd` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '时间段（1-4为am，4-10为pm）',
...
CREATE TABLE `queue_failures` (
  ...
  `executor_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='队列任务失败表，存储执行失败的任务记录';
...
CREATE TABLE `queue_groups` (
  ...
  CONSTRAINT `chk_queue_groups_status` CHECK ((`status` in (_utf8mb4'active',_utf8mb4'paused')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='队列分组状态表，存储队列分组的状态信息';
...
CREATE TABLE `queue_metrics` (
  ...
  `watermark_level` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='队列指标表，存储队列的实时状态和性能指标';
...
CREATE TABLE `queue_success` (
  ...
  `metadata` json DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='队列任务成功表，存储执行成功的任务记录';
...
CREATE TABLE `running_tasks` (
  `id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '任务ID',
  `parent_id` varchar(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '父任务ID',
  ...
  `task_type` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '任务类型',
  `status` enum('pending','running','paused') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT '任务状态',
  `priority` int NOT NULL DEFAULT '0' COMMENT '优先级',
  `progress` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT '进度百分比(0-100)',
  `executor_name` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '执行器名称',
...
CREATE TABLE `shared_contexts` (
  `id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '唯一标识符',
  `root_task_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '根任务ID',
  `data` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON序列化的共享数据',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
  `version` int NOT NULL DEFAULT '1' COMMENT '版本号',
  `checksum` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'SHA256校验和',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='任务树共享上下文存储表';
