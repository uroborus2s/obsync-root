...
| `pnpm --filter @stratix/core run test:coverage`       | passed | core coverage ratchet 通过：global lines `42.46%`、functions `36.76%`、branches `32.70%`、statements `41.75%`；bootstrap/discovery 关键路径使用更高目标阈值                                                                                                                                                                    |
